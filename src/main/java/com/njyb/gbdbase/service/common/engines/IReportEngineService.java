...
public interface IReportEngineService {
	 ...
	 * @return
	 */
	public abstract Map<String, List<DataReportSumModel>> builderMapList(
	 ...
	 * @return
	 */
	public abstract JSONArray buildJsonObject(ReportCommonParamModel  commonParamModel,boolean isShowAll);
