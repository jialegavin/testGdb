...
public class SalvatoreImportModel implements Serializable {

	/**
	 * 主键编号
	 */
	private Integer salvatoreImportId;
	...
	public Integer getSalvatoreImportId() {
		return salvatoreImportId;
	}

	public void setSalvatoreImportId(Integer salvatoreImportId) {
		this.salvatoreImportId = salvatoreImportId;
	}
