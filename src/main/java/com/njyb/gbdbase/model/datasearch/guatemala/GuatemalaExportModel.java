...
public class GuatemalaExportModel implements Serializable {

	/**
	 * 主键编号
	 */
	private Integer guatemalaExportId;
	...
	public Integer getGuatemalaExportId() {
		return guatemalaExportId;
	}


	public void setGuatemalaExportId(Integer guatemalaExportId) {
		this.guatemalaExportId = guatemalaExportId;
	}
