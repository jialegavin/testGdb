...
public class NicaraguaImportModel implements Serializable {

	/**
	 * 主键编号
	 */
	private Integer nicaraguaImportId;
	...
	public Integer getNicaraguaImportId() {
		return nicaraguaImportId;
	}

	public void setNicaraguaImportId(Integer nicaraguaImportId) {
		this.nicaraguaImportId = nicaraguaImportId;
	}
