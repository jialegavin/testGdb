package com.njyb.gbdbase.model.datasearch.nicaragua;
import java.io.Serializable;

@SuppressWarnings("serial")
public class NicaraguaExportModel implements Serializable {

	/**
	 * 
	 */
	private Integer nicaraguaExportId;
	...
	public Integer getNicaraguaExportId() {
		return nicaraguaExportId;
	}
	public void setNicaraguaExportId(Integer nicaraguaExportId) {
		this.nicaraguaExportId = nicaraguaExportId;
	}
