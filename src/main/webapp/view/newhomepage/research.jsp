...
<!-- About the stuff. -->
<div class="row" id="researcher">
            <div class="container">
            <div class="pad-section col-md-8 col-md-push-2">
<div class="splitter">
...
<div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <h2 class="featurette-heading">Press Research</h2>
          <p class="lead">Inforvellor provides you with access to export enterprise names, trade purchase information, and detailed exchange records. Know who’s buying or selling what product, when they’re doing it, and for how much. All of this information is at the tip of your fingers.</p>
        </div>
        <div class="col-md-7">
          <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" alt="500x500" src="<c:url value="/static/img/newhomepage/"/>" data-holder-rendered="true">
        </div>
      </div>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <h2 class="featurette-heading">Financial Research</h2>
          <p class="lead">Inforvellor offers data that can be used for looking into the past at historical financial research or for looking into the future at projected financial planning. We offer services that help you with both.</p>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <h2 class="featurette-heading">Legal Research</h2>
          <p class="lead">Inforvellor tracks product specifications, trade patterns, statistics on buyers and sellers, or even specific products via customs codes. Data is automatically received by our system in electronic form. We provide real bill of lading (Foreign B/L) information from over 22 countries.</p>
        </div>
        <div class="col-md-7">
          <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" alt="500x500" src="<c:url value="/static/img/newhomepage/"/>" data-holder-rendered="true">
        </div>
