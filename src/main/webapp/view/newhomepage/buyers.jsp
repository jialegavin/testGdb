...
<div class="container marketing">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7">
          <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" alt="500x500" src="<c:url value="/static/img/newhomepage/buyer1.JPG"/>" data-holder-rendered="true">
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" alt="500x500" src="<c:url value="/static/img/newhomepage/buyer2.JPG"/>" data-holder-rendered="true">
        </div>
        <div class="col-md-5">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7">
          <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" alt="500x500" src="<c:url value="/static/img/newhomepage/buyer3.JPG"/>" data-holder-rendered="true">
        </div>
      </div>
      </div>
