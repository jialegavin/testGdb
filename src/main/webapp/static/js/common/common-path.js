...
$(function() {
	...
	reportArray = {
		 ...
		 */
			// 屏蔽国家    '美国进口'
		'PORTOFSHIPMENT' : [ '中国','美国进口', '巴拿马进口', '智利进口', '智利出口','秘鲁进口', '巴拿马出口', '巴基斯坦进口',
		 ...
		 */
				// 屏蔽国家 '美国进口',  
		'PORTOFARRIVAL' : [ '中国','美国进口', '智利进口', '智利出口','秘鲁出口', '巴基斯坦进口', '越南进口', '尼加拉瓜进口',
		...
		'IMPORTERSUMMARY' : [ '中国','美国进口','阿根廷进口', '俄罗斯进口' , '俄罗斯出口' , '乌拉圭进口', '乌拉圭出口', '巴拉圭进口', '巴拉圭出口',
		 ...
		 */
				// 屏蔽国家  '美国进口', '俄罗斯', 
		'EXPORTERSUMMARY' : [ '中国','美国进口', '俄罗斯',  '巴拉圭进口', '巴拉圭出口', '秘鲁出口', '哥伦比亚进口', '哥伦比亚出口','智利进口','智利出口',
		 ...
		 * 趋势
		 */
		'TRANSACTIONTREND' : ['中国' ,'美国进口','巴基斯坦进口', '韩国',  '印度进口', '乌克兰进口', '英国进口', '俄罗斯进口' ,'俄罗斯出口',
		 ...
		 * 原产国
		 */
		'NATIVE' : ['中国', '阿根廷进口', '俄罗斯进口' , '俄罗斯出口','乌拉圭进口', '乌拉圭出口', '巴拉圭进口', '巴拉圭出口', '秘鲁进口', '智利出口',
		...
		*/
		...
		'ALL' : ['中国','阿根廷进口','阿根廷出口','智利进口','智利出口','哥伦比亚进口','哥伦比亚出口','哥斯达黎加进口',
		         '哥斯达黎加出口','巴拉圭进口','巴拉圭出口','俄罗斯进口','俄罗斯出口','厄瓜多尔进口','厄瓜多尔出口','印度进口','韩国',
		         '秘鲁进口','秘鲁出口','委内瑞拉进口','委内瑞拉出口','乌克兰进口','乌拉圭进口','乌拉圭出口','英国进口','巴基斯坦进口','美国进口',
		         '巴西进口','洪都拉斯进口','墨西哥进口','危地马拉进口','危地马拉出口','尼加拉瓜进口','尼加拉瓜出口','萨尔瓦多进口','萨尔瓦多出口',
		         '巴拿马进口','巴拿马出口','越南进口','越南出口','玻利维亚进口'],
//		'ALL' : ['中国' ,'美国进口','巴基斯坦进口', '韩国',  '印度进口', '乌克兰进口', '英国进口', '俄罗斯进口' ,'俄罗斯出口',
//				'墨西哥进口', '哥斯达黎加进口', '哥斯达黎加进口', '洪都拉斯进口', '委内瑞拉进口', '委内瑞拉出口',
//				'哥伦比亚进口', '哥伦比亚出口', '厄瓜多尔出口', '秘鲁进口', '秘鲁出口', '巴西进口', '巴拉圭进口',
//				'巴拉圭出口', '智利进口', '智利出口', '乌拉圭进口', '乌拉圭出口','阿根廷出口','阿根廷进口'],
		...
		*/
		// 屏蔽国家  '阿根廷进口', '俄罗斯进口' , '俄罗斯出口' , '美国进口', '中国', 
		'CUSTOMER_COMPITOR' : ['中国','美国','巴基斯坦', '韩国',  '印度', '乌克兰', '英国', '俄罗斯',
		             '墨西哥', '哥斯达黎加', '洪都拉斯', '委内瑞拉',
					'哥伦比亚', '厄瓜多尔', '秘鲁', '巴西', '巴拉圭'
					, '智利', '乌拉圭','阿根廷','菲律宾','越南','老挝','柬埔寨','缅甸','泰国','马来西亚','文莱','新加坡','印度尼西亚', 
					'东帝汶','尼泊尔','不丹','孟加拉国','印度','斯里兰卡','马尔代夫',
					'哈萨克斯坦','吉尔吉斯斯坦','塔吉克斯坦','乌兹别克斯坦','土库曼斯坦',
					'阿富汗','伊拉克','伊朗','叙利亚','约旦','黎巴嫩','以色列','巴勒斯坦','沙特阿拉伯','卡塔尔','科威特',
					'阿拉伯联合酋长国（阿联酋）','阿曼','也门','格鲁吉亚','亚美尼亚','阿塞拜疆','土耳其','塞浦路斯',
					'埃塞俄比亚','厄立特里亚','索马里','吉布提','肯尼亚','坦桑尼亚','乌干达','卢旺达','布隆迪','塞舌尔',
					'乍得','中非','喀麦隆','赤道几内亚','加蓬','刚果民主共和国','德国',
					'塞内加尔','冈比亚','马里','布基纳法索','几内亚','几内亚比绍','佛得角',
					'塞拉利昂','利比里亚','科特迪瓦','加纳','多哥','贝宁','尼日尔','加那利群岛'
					],
		...
		* @author jiahp
		*/
		'SAVECONDITION' : ['中国' ,'美国进口','巴基斯坦进口', '韩国',  '印度进口', '乌克兰进口', '英国进口', '俄罗斯进口' ,'俄罗斯出口',
								'墨西哥进口', '哥斯达黎加进口', '哥斯达黎加进口', '洪都拉斯进口', '委内瑞拉进口', '委内瑞拉出口',
								'哥伦比亚进口', '哥伦比亚出口', '厄瓜多尔出口', '秘鲁进口', '秘鲁出口', '巴西进口', '巴拉圭进口',
								'巴拉圭出口', '智利进口', '智利出口', '乌拉圭进口', '乌拉圭出口','阿根廷出口','阿根廷进口'
								,'萨尔瓦多进口','萨尔瓦多出口','危地马拉进口','危地马拉出口','尼加拉瓜进口','尼加拉瓜出口','玻利维亚进口'
								,'越南进口','巴拿马进口','巴拿马出口'],
								
		/**
		 * 下载全库
		 */
		'ALLDBDOWN' : ['中国','阿根廷进口','阿根廷出口','智利进口','智利出口','哥伦比亚进口','哥伦比亚出口','哥斯达黎加进口',
				         '哥斯达黎加出口','巴拉圭进口','巴拉圭出口','俄罗斯进口','俄罗斯出口','厄瓜多尔进口','厄瓜多尔出口','印度进口','韩国进口',
				         '韩国出口','秘鲁进口','秘鲁出口','委内瑞拉进口','委内瑞拉出口','乌克兰进口','乌拉圭进口','乌拉圭出口','英国进口','巴基斯坦进口','美国进口',
				         '巴西进口','洪都拉斯进口','墨西哥进口','危地马拉进口','危地马拉出口','尼加拉瓜进口','尼加拉瓜出口','萨尔瓦多进口','萨尔瓦多出口',
				         '巴拿马进口','巴拿马出口','越南进口','越南出口','玻利维亚进口'],
		 ...
		 * 卖家资源库
		 */				
		'BUYER' : ['中国','阿根廷进口','阿根廷出口','智利进口','智利出口','哥伦比亚进口','哥伦比亚出口','哥斯达黎加进口',
			         '哥斯达黎加出口','巴拉圭进口','巴拉圭出口','俄罗斯进口','俄罗斯出口','厄瓜多尔进口','厄瓜多尔出口','印度进口','韩国进口',
			         '韩国出口','秘鲁进口','秘鲁出口','委内瑞拉进口','委内瑞拉出口','乌克兰进口','乌拉圭进口','乌拉圭出口','英国进口','巴基斯坦进口','美国进口',
			         '巴西进口','洪都拉斯进口','墨西哥进口','危地马拉进口','危地马拉出口','尼加拉瓜进口','尼加拉瓜出口','萨尔瓦多进口','萨尔瓦多出口',
			         '巴拿马进口','巴拿马出口','越南进口','越南出口','玻利维亚进口'],
	     ...
	     * 日期格式为 年月 的国家
	     */
	    'YEARMONTHCOUNTRY' : ['中国','韩国','委瑞内拉','英国','巴西','洪都拉斯','墨西哥']
	};
	
	RIGHT = {
			'DOWNDB' : '在您的权限范围内下载不了数据!请修改查询条件，或详情致电：' + tell,
			'RIGHT_COUNT' : '您查看次数不足，详情请致电：<br/>' + tell,
			'RIGHT_DATE' : '您的用户时间过期，详情请致电：<br/> ' + tell,
			'NOT_RIGHT' : '您没有相应的权限，详情请致电：<br/> ' + tell
 	};
...
var getDomain = function(){
	...
	if (host == "www.ybdb.net") {
		tell = '025-66684219';
	} else if (host == "online.trade-easy.com.cn"){
		tell = '0513-85333684';
	}
}

var tell = '0513-85333684';
